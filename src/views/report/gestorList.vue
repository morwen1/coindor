<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="Gestor:">
        <template slot-scope="scope">
          <router-link :to="'/report/gestordetail/'+scope.row.users.id">
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getAll(this.listQuery, "reportes-gestor").then(response => {
