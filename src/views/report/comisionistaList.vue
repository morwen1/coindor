<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="Comisionista:">
        <template slot-scope="scope">
      ...
      <el-table-column label="Monto recaudado:">
        <template slot-scope="scope">
        ...
        <el-table-column label="Ganancia:">
        <template slot-scope="scope">
          <span>{{ getDecimal(scope.row.amountSend)*scope.row.users.commissions/100  }}  {{ scope.row.typeMoney }}</span>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getAll(this.listQuery, "reportes-comisionista").then(response => {
