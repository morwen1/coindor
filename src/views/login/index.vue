  ...
  <div class="login-container">
    ...
    <el-form class="login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
      ...
      <div class="title-container">
        <h3 class="title">Sistema  Administrador Casas de Cambios</h3>
      ...
      <el-button type="primary" style="width:100%;margin-bottom:30px;" :loading="loading" @click.native.prevent="handleLogin">Iniciar Sesión</el-button>
...
export default {
  ...
  data() {
    ...
    const validatePassword = (rule, value, callback) => {
      if (value.length < 3) {
        callback(new Error('La contraseña no puede tener menos de 3 dígitos'))
      } else {
        callback()
      }
    }
